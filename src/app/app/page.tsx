...
function MultiViewPlayer({
  ...
  // Chat is now handled by the real ChatPanel component
  ...
  // Chat reactions and auto-pin now handled by ChatPanel component
  ...
  if (!user) {
    return (
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/10 hover:bg-white/15 text-gray-300 hover:text-white text-xs font-medium transition-colors"
      >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden animate-menu-fade border-t border-white/5" style={{ background: 'rgba(15,23,36,0.95)' }}>
            <nav className="flex flex-col px-4 py-3 space-y-2">
              ...
              <Link href="/app/trend" onClick={() => setMobileMenuOpen(false)} className="px-3 py-2 rounded-lg text-sm font-medium text-gray-400 hover:bg-white/5 hover:text-white transition-colors">
                📊 Trend
              </Link>
